function upGeoViet(d) { 
    ...
    c.innerHTML = '<IFRAME onload=this.onload_callback() src="about:blank" name="' + n + '"></IFRAME>'; 
...
function regisUpload(url,e,truoc) {
    upGeoViet(
   {
       element: e,
       action: url,
     ...
     function (r) {
         ...
         var img = truoc?"#img_truoc":"#img_sau";
